...
void Function :: Print () {
	...
	for (int i = 0; i < numOps; i++) {
		...
		switch (opList[i].myOp) {
			...
			//case PushInt:  cout << "pushint=" << *(int *)opList[i].litInput; break;
			case PushInt:  cout << "pushintconst"; break;
			//case PushDouble: cout << "pushdbl="<< *(double *)opList[i].litInput; break;
			case PushDouble: cout << "pushdblconst"; break;
			case ToDouble: cout << "casttodbl";break;
			case ToDouble2Down: cout << "castdbl2dwn "; break;
			case IntUnaryMinus: cout << "subint"; break;
			case DblUnaryMinus: cout << "subdbl"; break;
			case IntMinus: cout << "subint"; break;
			case DblMinus: cout << "subdbl"; break;
			case IntPlus: cout << "addints"; break;
			case DblPlus: cout << "adddbls"; break;
			case IntDivide: cout << "divints"; break;
			case DblDivide: cout << "divdbls"; break;
			case IntMultiply: cout << "multints"; break;
			case DblMultiply: cout << "multdbls"; break;
			default: cout << "unknown_op"; break;
		}	
		cout << "," << opList[i].recInput << ")  ";
	}
	cout << "\n";
}
